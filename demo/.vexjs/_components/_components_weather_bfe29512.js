...
import { html } from '/_vexjs/services/html.js';  
    ...
    48: { description: "Niebla con escarcha", icon: "🌫️", color: "text-blue-300" },
  ...
  // this is not a good use of watch, because in a normal component, we wi
  watch(
    () => cityParam,
  ...
  const currentWeather = computed(() =>
    ...
    <div class="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl p-6 text-white shadow-lg">
      <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div x-show="${!params.city}" class="flex flex-wrap gap-2">
